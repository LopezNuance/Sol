...
```json
{
  ...
  "instruction_ref": "object:sha256:a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0",
...
The `context_status` field uses recommended values that are not part of the registered status vocabularies enforced by V0-04. Validator implementations MUST NOT reject unknown `context_status` values; `context_status` remains open pending the registry decision in post-v0.1 #12.
...
V0-04  All committed status values in registered vocabularies for lifecycle,
       staleness, and verification fields. The context_status field is not
       subject to this rule; it uses recommended values pending the registry
       decision in post-v0.1 #12.
